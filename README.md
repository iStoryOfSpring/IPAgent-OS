...
Bash
git clone [https://github.com/你的用户名/IPAgent-OS.git](https://github.com/你的用户名/IPAgent-OS.git)
cd IPAgent-OS
...
3. M4 Chip & Multi-core Parallel Optimization
...
Bash
git clone https://github.com/your-username/IPAgent-OS.git
cd IPAgent-OS
pip install -r requirements.txt
